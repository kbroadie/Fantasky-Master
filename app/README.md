...
| **Cast** | A strip of names in standings order above swipeable contestant pages: portrait and total, how often the league picked them, points per episode as bars in their colour (a crown for a win), a strengths radar of their Prize, Filmed and Live points per episode (the edge of the circle is the best by any contestant in any series; team tasks aren't counted), then the bio and a stat. |
