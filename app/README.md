...
| **Cast** | A strip of names in standings order above swipeable contestant pages: portrait and total, how often the league picked them, points per episode as bars in their colour on one scale (a crown for a win), with a dashed line at the series median, a Performance radar of their Prize, Filmed and Live points per episode as z-scores against all 110 contestants in Taskmaster history (each axis shows its z-score, e.g. +2.48σ; rings every σ from −3σ at the centre to +3σ at the edge, the dashed ring is average; team tasks aren't counted), then their **Profile** (a short bio and personal facts: age, star sign, height, birthplace, education, family, awards and more) and a statistical insight. Above the bars, for finished series, **All-time records** lists every stat where they rank in the top 10 of the 105 contestants in finished series (e.g. "Speed demon =#5: 4.00 points per fastest-wins task"). The series still airing gets none until its final, because a few episodes are too few to rank. |
