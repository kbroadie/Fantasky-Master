...
| Tab | What's on it |
|---|---|
| **Standings** | Last week at a glance: the winner's portrait, who called it, and who leads Show and League (tap it to open that episode). Then one table with every player's rank and movement and their Show and League points. For Series 22, behind each row is the contestant they picked this week, their hero shot stretched across the whole row with the eyes centred (warmed gold if the pick won). Series 21 has no hero shots, so it shows the pick as a small framed face instead. Tap **Show** or **League** to sort (▼/▲ shows the direction). Tap a player (the chevron) to open their ten weekly picks. |
