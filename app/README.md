...
| Tab | What's on it |
|---|---|
| **Standings** | Last week at a glance: the winner's portrait, who called it, and who leads Show and League (tap it to open that episode). Then one table with every player's rank and movement and their Show and League points. For Series 22, behind each row is the contestant they picked this week: their hero shot blown up across the whole row, eyes centred, past the temple pillars (warmed gold if the pick won). Opening a row uncovers more of the photo. Series 21 has no hero shots, so its rows are plain. Tap **Show** or **League** to sort (▼/▲ shows the direction). Tap a player (the chevron) to open their ten weekly picks. |
