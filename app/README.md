...
| **Cast** | A strip of names in standings order above swipeable contestant pages: portrait and total, how often the league picked them, points per episode as bars in their colour (a crown for a win), a strengths triangle of their Prize, Filmed and Live points (each corner is the best in the cast; team tasks aren't counted), then the bio and a stat. |
