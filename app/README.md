...
| Tab | What's on it |
|---|---|
| **Standings** | Last week at a glance: the winner's portrait, who called it, and who leads Show and League (tap it to open that episode). Then one table with every player's rank and movement, a 👑 on the Show leader and a 🏆 on the League leader, and their Show and League points. Behind each row is the contestant they picked this week, a close crop of their hero shot with the eyes centred in the row (warmed gold if the pick won). Tap **Show** or **League** to sort (▼/▲ shows the direction). Tap a player (the chevron) to open their ten weekly picks. |
