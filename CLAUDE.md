...
- **Episodes / Cast:** a tab strip over scroll-snapped slides.
  ...
  - The league's picks list each contestant's backers as plain comma-separated names (no pills, not bold). The contestant names are in Fredoka like everywhere else.
